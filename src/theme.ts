...
export const SCENARIO_CENTRE_COLORS: Record<string, string> = {
  ...
  "kanye-west": "#1a1008",
  kyiv: "#0e1a2e",
  "golden-age-piracy": "#060e1c",
  "trial-of-socrates": "#1a1400",
  homer: "#160e00",
  "mediterranean-summer": "#1a1208",
  "suez-canal": "#1a1005",
  "swimming-leisure": "#081420",
  "cholera-map": "#081822",
  "opium-empire": "#0a1a10",
  "window-tax": "#1e1508",
  bedlam: "#141018",
...
const SCENARIO_GRADIENTS: Record<string, string> = {
  ...
  "golden-age-piracy": "radial-gradient(ellipse at center, #060e1c 0%, #0D0D0D 70%)",
  "trial-of-socrates": "radial-gradient(ellipse at center, #1a1400 0%, #0D0D0D 70%)",
  homer: "radial-gradient(ellipse at center, #160e00 0%, #0D0D0D 70%)",
  "mediterranean-summer": "radial-gradient(ellipse at center, #1a1208 0%, #0D0D0D 70%)",
  "suez-canal": "radial-gradient(ellipse at center, #1a1005 0%, #0D0D0D 70%)",
  "swimming-leisure": "radial-gradient(ellipse at center, #081420 0%, #0D0D0D 70%)",
