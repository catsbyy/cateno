      ...
      {node && (
        ...
        >
          ...
          >
            ...
            {/* Title */}
            <h2
              className="text-[#E8E3D5] text-[20px] font-serif leading-snug mb-3"
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin">
            ...
            <div className="px-6 py-5" style={{ borderBottom: '1px solid #1e1e1e' }}>
              <p className="text-[#E8E3D5]/75 text-[14px] font-sans leading-relaxed">
                {node.summary}
              </p>
            </div>
            ...
            {causeNodes.length > 0 && (
              <div className="px-6 py-5" style={{ borderBottom: '1px solid #1e1e1e' }}>
                <p className="text-[#E8E3D5]/30 text-[11px] font-sans uppercase tracking-widest mb-3">
                  Caused by
                </p>
